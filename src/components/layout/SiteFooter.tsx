...
const COLUNAS = [
  { titulo: 'Produto', links: [['Para corretores', '/para-corretores'], ['Para prestadores', '/para-prestadores'], ['Encontrar prestador', '/servicos/encanador/sao-paulo'], ['Preços', '/para-corretores#planos'], ['Baixe o app', '/baixar']] },
